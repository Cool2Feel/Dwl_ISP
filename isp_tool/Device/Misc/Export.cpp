...
// * @return 是否成功
// */
//DEVICE_API bool SoftwareResetUsbDeviceEx(const wchar_t* deviceSymbolicLink, 
//                                          int waitDisconnectMs, 
//                                          int waitConnectMs)
//{
//    return ::SoftwareResetUsbDeviceEx(deviceSymbolicLink, waitDisconnectMs, waitConnectMs);
//}
//
///**
...
// * @return 是否成功
// */
//DEVICE_API bool SoftwareResetUsbDeviceSimple(const wchar_t* deviceSymbolicLink)
//{
//    return ::SoftwareResetUsbDeviceSimple(deviceSymbolicLink);
//}
